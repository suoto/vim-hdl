...
class HDLCodeCheckerClient(ProjectBuilder):
    ...
    def _handleUiInfo(self, message):
        ...
        if self._isMainThread():
            ...
            self._ui_msg_queue.put({'type' : 'info', 'text' : message})
    ...
    def _handleUiWarning(self, message):
        ...
        if self._isMainThread():
            ...
            self._ui_msg_queue.put({'type' : 'warning', 'text' : message})
    ...
    def _handleUiError(self, message):
        ...
        if self._isMainThread():
            ...
            self._ui_msg_queue.put({'type' : 'error', 'text' : message})
...
@vimWrap
def onBufRead(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onBufReadPost(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onBufWrite(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onBufWritePost(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onBufEnter(client, vim_buffer):
    pass

@vimWrap
def onBufLeave(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onBufWinEnter(client, vim_buffer):
    pass

@vimWrap
def onBufWinLeave(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onFocusGained(client, vim_buffer):
    pass

@vimWrap
def onFocusLost(client, vim_buffer):
    pass

@vimWrap
def onCursorHold(client, vim_buffer):
    pass

@vimWrap
def onCursorHoldI(client, vim_buffer):
    pass

@vimWrap
def onWinEnter(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onWinLeave(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onTabEnter(client, vim_buffer):
    pass

@vimWrap
def onTabLeave(client, vim_buffer): # pragma: no cover
    pass

@vimWrap
def onVimLeave(client, vim_buffer): # pragma: no cover
    pass
