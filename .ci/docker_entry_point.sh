...
function _install_packages {
  pip2 install -r ./.ci/requirements.txt
...
# pip3 install git+https://github.com/google/vroom
pip3 install requests hdl-checker

# xvfb-run --server-args='-screen 0, 1024x768x24' 
vroom -u ~/dot_vim/vimrc --nocolor -d 0.5 .ci/vroom
